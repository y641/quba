...
export default class Index extends Component {
  ...
  componentWillMount() {
    ...
    this.setState({ getinfo:info,money})
  }
  onChange = e =>  {
    this.setState({
            ...
            success: (res) => {
             ...
             if (res.data && res.data.resultCode === 0) {
              if (this.state.name === '') {
               ...
               Taro.navigateTo({ url: `/pages/registration_check/registration_check?name=${this.state.name}&mobile=${this.state.mobile}&selector=${this.state.selectorChecked}&idcard=${this.state.idCard}&info=${JSON.stringify(this.state.getinfo)}&money=${JSON.stringify(this.state.money)}` })
              }
              }
            }
          })
